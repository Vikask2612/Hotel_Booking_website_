  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg mb-8">
        Welcome to <span className="text-brand">Hotel Taj</span>, where we are
      ...
      <p className="text-lg mb-8">
        At <span className="text-brand">Hotel Taj</span>, we envision a world
      ...
      <p className="text-lg">
        Thank you for choosing <span className="text-brand">Hotel Taj</span>.
